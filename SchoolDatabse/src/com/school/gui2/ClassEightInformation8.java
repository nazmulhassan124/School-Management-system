...
public class ClassEightInformation8 extends javax.swing.JFrame {
DefaultTableModel model;
Connection con =null;
Statement stmt= null;
    
    public ClassEightInformation8() {
        initComponents();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       jTabbedPane1.setSelectedIndex(1);
        ...
        String sql ="select * from studentsnewtable where class_name='Eight'  order by class_roll ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassEightInformation8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassEightInformation8().setVisible(true);
            }
        });
    }
