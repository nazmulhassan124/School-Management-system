...
public class ClassOneInformation extends javax.swing.JFrame {

    DefaultTableModel model; 
    public ClassOneInformation() {
        initComponents();
    }
...
Statement stmt= null;
    ...
    private void initComponents() {
        ...
        one_result = new javax.swing.JButton();
        jButton12 = new javax.swing.JButton();
        one_fees = new javax.swing.JButton();
        ...
        one_result_table = new javax.swing.JTable();
        ...
        one_result.setBackground(new java.awt.Color(0, 0, 0));
        one_result.setForeground(new java.awt.Color(255, 255, 255));
        one_result.setText("Result");
        one_result.setBorder(null);
        one_result.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                one_resultActionPerformed(evt);
            }
        });
        jPanel2.add(one_result, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 170, 34));

        jButton12.setBackground(new java.awt.Color(0, 0, 0));
        jButton12.setForeground(new java.awt.Color(255, 255, 255));
        jButton12.setText("Class One");
        jButton12.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 10, 370, 33));

        one_fees.setBackground(new java.awt.Color(0, 0, 0));
        one_fees.setForeground(new java.awt.Color(255, 255, 255));
        one_fees.setText("Fees status");
        one_fees.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        one_fees.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                one_feesActionPerformed(evt);
            }
        });
        jPanel2.add(one_fees, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 170, 29));
        ...
        one_result_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane2.setViewportView(one_result_table);

        jPanel4.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 87, 1010, 340));

        first.setText("1st Semister");
        first.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                firstActionPerformed(evt);
            }
        });
        jPanel4.add(first, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 40, 110, -1));

        jButton2.setText("2nd Semister");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        jPanel4.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 40, 120, -1));

        jButton3.setText("Third Semister");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        jPanel4.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, 120, -1));
    ...
    private void one_resultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_one_resultActionPerformed
        // TODO add your handling code here:
       jTabbedPane1.setSelectedIndex(2);
       
       
    }//GEN-LAST:event_one_resultActionPerformed
    ...
    private void one_stu_list_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_one_stu_list_btnActionPerformed
       ...
       jTabbedPane1.setSelectedIndex(1);
        ...
        String sql ="select * from studentsnewtable where class_name='One'  order by class_roll ";
...
// -------Class one markslist start-------
    
 
  
    public void onemarklist (String f1,String c1){
        ...
        String sq="select * from exammarkstable where semister = ? and class_name=?";
        
        try {
         con = DBCconnection.getConnection();
        PreparedStatement psm = con.prepareStatement(sq);
           psm.setString(1, f1);
      ...
      one_result_table.setModel(model);
        } catch (Exception e) {
                System.out.println(e);
        }  finally{try {
                con.close();
    ...
    private void one_feesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_one_feesActionPerformed
        // TODO add your handling code here:
        jTabbedPane1.setSelectedIndex(3);
    }//GEN-LAST:event_one_feesActionPerformed
    ...
    private void firstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_firstActionPerformed
       ...
       onemarklist ("First Semister","One"); 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        onemarklist ("Second Semister","One"); 
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        onemarklist ("Third Semister","One"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassOneInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassOneInformation().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton one_fees;
    private javax.swing.JButton one_result;
    private javax.swing.JTable one_result_table;
